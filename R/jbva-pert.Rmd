...
.pull-left[
### Purpose
The Pulmonary Embolism Response Team (PERT) at the Jesse Brown VA (JBVA) has been initialized. The following is to identify the purpose and structure of this new service.
]
...
1. Be aware of the call schedule and call obligations
...
Major purpose of a PERT at JBVA is...
...
1. Call Fellows = primary responsibility for responding to PERT activations (whether interventional or not) and triaging needs/resources required, both IR and cardiology
...
1. Attendings = provide back-up support and decision making on acuity and need for intervention
...
- Dr. Goodwin
- Dr. Gupta
- JBVA cardiology Fellows
- JBVA residents and interns
- PERT Research Team
]
